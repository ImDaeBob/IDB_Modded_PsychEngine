...
class TitleState extends MusicBeatState
{
	...
	// JSON data
	var characterImage:String = 'danceTitle';
	...
	{
		if(Paths.fileExists('images/danceTitle.json', TEXT))
		{
			var titleRaw:String = Paths.getTextFromFile('images/danceTitle.json');
			if(titleRaw != null && titleRaw.length > 0)
			{
				try
				{
					var titleJSON:TitleData = tjson.TJSON.parse(titleRaw);
					gfPosition.set(titleJSON.sprx, titleJSON.spry);
