...
class DiscordClient
{
	...
	public static function changePresence(details:String = 'Booting up', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
